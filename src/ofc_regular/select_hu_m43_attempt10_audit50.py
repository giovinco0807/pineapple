"""Apply the predeclared one-shot Attempt10 Audit50 search-quality gates."""
...
from .select_hu_m43_attempt10_development import _attempt10_selector_bindings


ATTEMPT10_AUDIT50_DECISION_SCHEMA = "hu_m43_attempt10_audit50_go_no_go_v1"
ATTEMPT10_AUDIT50_RECEIPT_SCHEMA = "hu_m43_attempt10_audit50_selector_receipt_v1"
ATTEMPT10_AUDIT50_RECEIPT_KEYS = frozenset(
    {
        "schema",
        "status",
        "run_name",
...
_AUDIT_BINDINGS: dict[str, Any] = {
    "ATTEMPT09_DEVELOPMENT_DECISION_SCHEMA": ATTEMPT10_AUDIT50_DECISION_SCHEMA,
    "ATTEMPT09_DEVELOPMENT_RECEIPT_SCHEMA": ATTEMPT10_AUDIT50_RECEIPT_SCHEMA,
    "_ROOTS": 50,
    ...
    "GO_STATUS": "go_attempt10_audit50_search_quality",
    "NO_GO_STATUS": "no_go_close_attempt10_audit50",
    "_GATES": _AUDIT_GATES,
...
@contextmanager
def _attempt10_audit_bindings() -> Iterator[None]:
...
def aggregate_attempt10_audit50_rows(
...
def execute_attempt10_audit50_selector(
    *,
    input_path: str | Path,
    plan_path: str | Path,
    ...
    with _attempt10_audit_bindings():
        ...
        if destination.exists():
            raise FileExistsError(
                f"Attempt10 audit50 selector output already exists: {destination}"
            )
        ...
        try:
            ...
            receipt = {
                "schema": ATTEMPT10_AUDIT50_RECEIPT_SCHEMA,
            ...
            _validate_attempt10_audit50_receipt(
                receipt,
                run_name=run_name,
                decision=report["decision"],
                decision_sha256=hashlib.sha256(decision_bytes).hexdigest(),
...
def _validate_attempt10_audit50_receipt(
    ...
    *,
    ...
    if (
        ...
        or receipt.get("schema") != ATTEMPT10_AUDIT50_RECEIPT_SCHEMA
        ...
        raise ValueError("Attempt10 audit50 selector receipt contract changed")
...
__all__ = [
    ...
    "aggregate_attempt10_audit50_rows",
