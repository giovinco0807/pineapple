"""Run one restart-safe Attempt13 search root.

Attempt13 deliberately reuses the proven Attempt09 persistence/root mechanics,
but binds them to the Attempt13 plan, seed schedule, teacher, and fresh artifact
schemas for exactly one synchronous call.  All base-module globals are restored
after the call so Attempt12 and earlier attempts remain immutable.
"""
...
ATTEMPT13_ROW_SCHEMA = "hu_m43_attempt13_search_root_v1"
ATTEMPT13_CHECKPOINT_SCHEMA = "hu_m43_attempt13_search_checkpoint_v1"
ATTEMPT13_HEARTBEAT_SCHEMA = "hu_m43_attempt13_search_heartbeat_v1"
ATTEMPT13_SUMMARY_SCHEMA = "hu_m43_attempt13_search_summary_v1"
ATTEMPT13_AUTHORIZATION_SCHEMA = "hu_m43_attempt13_execution_authorization_v1"
ATTEMPT13_ROOT_CONTRACT_SCHEMA = "hu_m43_attempt13_root_contract_v1"
ATTEMPT13_BASELINE_PROFILE = "stage18_p1"
ATTEMPT13_CONTINUATION_PROFILE = "stage9f_p2"
ATTEMPT13_NATIVE_BATCH_THREADS = 4
ATTEMPT13_LAMBDA_MODEL_SHA256 = ATTEMPT12_LAMBDA_MODEL_SHA256
...
_ATTEMPT13_BINDINGS: dict[str, Any] = {
    ...
    "FrozenAttempt09LambdaRanker": FrozenAttempt13LambdaRanker,
    "evaluate_attempt09_t1_second": evaluate_attempt13_t1_second,
    "validate_attempt09_teacher_output": validate_attempt13_teacher_output,
    "ATTEMPT09_ROW_SCHEMA": ATTEMPT13_ROW_SCHEMA,
    "ATTEMPT09_CHECKPOINT_SCHEMA": ATTEMPT13_CHECKPOINT_SCHEMA,
    "ATTEMPT09_HEARTBEAT_SCHEMA": ATTEMPT13_HEARTBEAT_SCHEMA,
    "ATTEMPT09_SUMMARY_SCHEMA": ATTEMPT13_SUMMARY_SCHEMA,
    "ATTEMPT09_AUTHORIZATION_SCHEMA": ATTEMPT13_AUTHORIZATION_SCHEMA,
    "ATTEMPT09_ROOT_CONTRACT_SCHEMA": ATTEMPT13_ROOT_CONTRACT_SCHEMA,
    "ATTEMPT09_BASELINE_PROFILE": ATTEMPT13_BASELINE_PROFILE,
    "ATTEMPT09_CONTINUATION_PROFILE": ATTEMPT13_CONTINUATION_PROFILE,
    "ATTEMPT09_NATIVE_BATCH_THREADS": ATTEMPT13_NATIVE_BATCH_THREADS,
}


@contextmanager
def _attempt13_bindings() -> Iterator[None]:
    """Install Attempt13 bindings atomically and restore the generic runner."""

    with _BIND_LOCK:
        prior = {name: getattr(_base, name) for name in _ATTEMPT13_BINDINGS}
        try:
            for name, value in _ATTEMPT13_BINDINGS.items():
...
def run_attempt13_root(
    *,
    ...
    native_batch_threads: int = ATTEMPT13_NATIVE_BATCH_THREADS,
    paths: ModelPaths | None = None,
) -> dict[str, Any]:
    """Generate or validate exactly one deterministic Attempt13 row."""
...
__all__ = [
    ...
    "ATTEMPT13_CHECKPOINT_SCHEMA",
    "ATTEMPT13_HEARTBEAT_SCHEMA",
    "ATTEMPT13_ROOT_CONTRACT_SCHEMA",
    "ATTEMPT13_ROW_SCHEMA",
    "ATTEMPT13_SUMMARY_SCHEMA",
    "run_attempt13_root",
]
