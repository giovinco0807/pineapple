"""Run one restart-safe Attempt10 search root.
...
Attempt10 plan and teacher for the duration of one call, then restores every
...
ATTEMPT10_ROW_SCHEMA = "hu_m43_attempt10_search_root_v1"
ATTEMPT10_CHECKPOINT_SCHEMA = "hu_m43_attempt10_search_checkpoint_v1"
ATTEMPT10_HEARTBEAT_SCHEMA = "hu_m43_attempt10_search_heartbeat_v1"
ATTEMPT10_SUMMARY_SCHEMA = "hu_m43_attempt10_search_summary_v1"
ATTEMPT10_AUTHORIZATION_SCHEMA = "hu_m43_attempt10_execution_authorization_v1"
ATTEMPT10_ROOT_CONTRACT_SCHEMA = "hu_m43_attempt10_root_contract_v1"
ATTEMPT10_BASELINE_PROFILE = "stage18_p1"
ATTEMPT10_CONTINUATION_PROFILE = "stage9f_p2"
ATTEMPT10_NATIVE_BATCH_THREADS = 4
...
_ATTEMPT10_BINDINGS: dict[str, Any] = {
    ...
    "FrozenAttempt09LambdaRanker": FrozenAttempt10LambdaRanker,
    "evaluate_attempt09_t1_second": evaluate_attempt10_t1_second,
    "validate_attempt09_teacher_output": validate_attempt10_teacher_output,
    "ATTEMPT09_ROW_SCHEMA": ATTEMPT10_ROW_SCHEMA,
    "ATTEMPT09_CHECKPOINT_SCHEMA": ATTEMPT10_CHECKPOINT_SCHEMA,
    "ATTEMPT09_HEARTBEAT_SCHEMA": ATTEMPT10_HEARTBEAT_SCHEMA,
    "ATTEMPT09_SUMMARY_SCHEMA": ATTEMPT10_SUMMARY_SCHEMA,
    "ATTEMPT09_AUTHORIZATION_SCHEMA": ATTEMPT10_AUTHORIZATION_SCHEMA,
    "ATTEMPT09_ROOT_CONTRACT_SCHEMA": ATTEMPT10_ROOT_CONTRACT_SCHEMA,
    "ATTEMPT09_BASELINE_PROFILE": ATTEMPT10_BASELINE_PROFILE,
    "ATTEMPT09_CONTINUATION_PROFILE": ATTEMPT10_CONTINUATION_PROFILE,
    "ATTEMPT09_NATIVE_BATCH_THREADS": ATTEMPT10_NATIVE_BATCH_THREADS,
}
...
def run_attempt10_root(
    *,
    ...
    native_batch_threads: int = ATTEMPT10_NATIVE_BATCH_THREADS,
    paths: ModelPaths | None = None,
) -> dict[str, Any]:
    """Generate or validate exactly one deterministic Attempt10 row."""
...
__all__ = [
    ...
    "ATTEMPT10_CHECKPOINT_SCHEMA",
    "ATTEMPT10_HEARTBEAT_SCHEMA",
    "ATTEMPT10_ROOT_CONTRACT_SCHEMA",
    "ATTEMPT10_ROW_SCHEMA",
    "ATTEMPT10_SUMMARY_SCHEMA",
    "run_attempt10_root",
]
