"""Run one restart-safe Attempt11 search root.
...
Attempt11 plan and teacher for the duration of one call, then restores every
...
ATTEMPT11_ROW_SCHEMA = "hu_m43_attempt11_search_root_v1"
ATTEMPT11_CHECKPOINT_SCHEMA = "hu_m43_attempt11_search_checkpoint_v1"
ATTEMPT11_HEARTBEAT_SCHEMA = "hu_m43_attempt11_search_heartbeat_v1"
ATTEMPT11_SUMMARY_SCHEMA = "hu_m43_attempt11_search_summary_v1"
ATTEMPT11_AUTHORIZATION_SCHEMA = "hu_m43_attempt11_execution_authorization_v1"
ATTEMPT11_ROOT_CONTRACT_SCHEMA = "hu_m43_attempt11_root_contract_v1"
ATTEMPT11_BASELINE_PROFILE = "stage18_p1"
ATTEMPT11_CONTINUATION_PROFILE = "stage9f_p2"
ATTEMPT11_NATIVE_BATCH_THREADS = 4
...
_ATTEMPT11_BINDINGS: dict[str, Any] = {
    ...
    "FrozenAttempt09LambdaRanker": FrozenAttempt11LambdaRanker,
    "evaluate_attempt09_t1_second": evaluate_attempt11_t1_second,
    "validate_attempt09_teacher_output": validate_attempt11_teacher_output,
    "ATTEMPT09_ROW_SCHEMA": ATTEMPT11_ROW_SCHEMA,
    "ATTEMPT09_CHECKPOINT_SCHEMA": ATTEMPT11_CHECKPOINT_SCHEMA,
    "ATTEMPT09_HEARTBEAT_SCHEMA": ATTEMPT11_HEARTBEAT_SCHEMA,
    "ATTEMPT09_SUMMARY_SCHEMA": ATTEMPT11_SUMMARY_SCHEMA,
    "ATTEMPT09_AUTHORIZATION_SCHEMA": ATTEMPT11_AUTHORIZATION_SCHEMA,
    "ATTEMPT09_ROOT_CONTRACT_SCHEMA": ATTEMPT11_ROOT_CONTRACT_SCHEMA,
    "ATTEMPT09_BASELINE_PROFILE": ATTEMPT11_BASELINE_PROFILE,
    "ATTEMPT09_CONTINUATION_PROFILE": ATTEMPT11_CONTINUATION_PROFILE,
    "ATTEMPT09_NATIVE_BATCH_THREADS": ATTEMPT11_NATIVE_BATCH_THREADS,
}
...
def run_attempt11_root(
    *,
    ...
    native_batch_threads: int = ATTEMPT11_NATIVE_BATCH_THREADS,
    paths: ModelPaths | None = None,
) -> dict[str, Any]:
    """Generate or validate exactly one deterministic Attempt11 row."""
...
__all__ = [
    ...
    "ATTEMPT11_CHECKPOINT_SCHEMA",
    "ATTEMPT11_HEARTBEAT_SCHEMA",
    "ATTEMPT11_ROOT_CONTRACT_SCHEMA",
    "ATTEMPT11_ROW_SCHEMA",
    "ATTEMPT11_SUMMARY_SCHEMA",
    "run_attempt11_root",
]
