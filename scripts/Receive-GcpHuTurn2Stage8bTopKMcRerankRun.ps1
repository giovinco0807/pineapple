param(
    ...
    [string]$RunName,
    [string]$DownloadDir,
    [string]$OutputDir = "outputs/evals/hu_turn2_stage8b_topk_mc_rerank_gcp"
)
...
if ($missing.Count -gt 0) {
    throw "Missing TopK rerank result shards: $($missing -join ',')"
}

python -m ofc_regular.aggregate_hu_turn2_stage8b_topk_mc_rerank `
